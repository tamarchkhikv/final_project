...
const Settings = () => {
  return (
    <div>
      ...
      <form className='max-w-[1069px] mx-auto bg-white mt-16 py-8 border-b-[1px] ml-12 h-[588px] '>
        ...
        <div className=' flex flex-col w-80 h-[239px] ml-12 gap-4 mt-16'>
          <div>
            ...
            <input required type='text' className='w-80 h-[45px] border-[1px] rounded-md px-[15px] py-[10px] outline-none'></input>
          </div>
          <div>
