    ...
    return (
        <form className="px-12 h-[504px] border-l-[1px] mt-16 mb-[131px] w-[534px]">
            ...
            <div className="mt-10">
                ...
                <input required type='text' className="w-[534px] h-11 border-[1px] rounded-md px-[15px] py-[10px] outline-none "></input>
            </div>
            <div className="flex gap-4 mt-4">
                <div>
                    <label className="font-medium text-sm text-[#000000]">City</label>
                    <input required type='text' className="w-[259px] h-11 border-[1px] rounded-md px-[15px] py-[10px] outline-none "></input>
                </div>
                <div>
